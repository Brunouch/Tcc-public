...
<div class="col d-flex justify-content-end">
    <a href="{{ route('clientes.create') }}" class="btn btn-primary">Cadastrar
        ...
        <table class="table align-middle caption-top table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('clientes.edit', $item->id) }}" class="btn btn-success">Editar
                        ...
                        <a nohref style="cursor:pointer" onclick="showRemoveModal('{{ $item->id }}', '{{ $item->nome }}', '{{ $item->idade }}', '{{ $item->sexo }}', '{{ $item->dataInter }}', '{{ $item->diagnosticoInter }}', '{{ $item->diagnosticoClin }}', '{{ $item->dataIOT }}', '{{ $item->altura }}', '{{ $item->pesoIdeal }}', '{{ $item->diasInter }}')" class="btn btn-danger">Excluir
