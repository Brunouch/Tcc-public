@extends('templates.middleware', ['titulo' => "Ventilador Mecânico Padrão", 'rota' => "padrao.create"])
<!-- Preenche o conteúdo da seção "titulo" -->
@section('titulo') Ventilador Mecânico Padrão @endsection
<!-- Preenche o conteúdo da seção "conteudo" -->
@section('conteudo')
<div class="col d-flex justify-content-end">
     <a href="{{ route('padrao.create') }}" class="btn btn-primary">Cadastrar
...
<div class="row">
     <div class="col">
          <table class="table align-middle caption-top table-striped">
               <caption>Tabela de <b>Ventilador Mecânico Padrão</b></caption>
               <thead>
                    <tr>
               ...
               <tbody>
                    ...
                    <tr>
                         ...
                         <td>
                              <a href="{{ route('padrao.edit', $item->id) }}" class="btn btn-success">Editar
                         ...
                         <form action="{{ route('padrao.destroy', $item->id) }}" method="POST" id="form_{{$item->id}}">
                              @csrf
                              @method('DELETE')
                         </form>
                    </tr>
