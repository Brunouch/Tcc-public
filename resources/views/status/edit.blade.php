...
<form action="{{ route('status.update', $status->id) }}" method="POST" id="formUpdate">
    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <input type="datetimepicker" class="form-control @if($errors->has('dataHora')) is-invalid @endif" name="dataHora" placeholder="dataHora" value="{{$status->dataHora}}" />
                ...
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @if($errors->has('sedacao')) is-invalid @endif" name="sedacao" placeholder="sedacao" value="{{$status->sedacao}}" />
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @if($errors->has('pa')) is-invalid @endif" name="pa" placeholder="pa" value="{{$status->pa}}" />
