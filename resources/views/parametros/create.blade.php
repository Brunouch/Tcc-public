...
<form action="{{ route('parametros.store') }}" method="POST">
          ...
          <div class="col">
               <div class="input-group mb-3">
                    ...
                    <select name="vent_id" class="form-select @if($errors->has('vent_id')) is-invalid @endif">
                         @foreach ($ventiladorMec as $item)
                         <option value="{{$item->id}}" @if($item->id == old('vent_id')) selected="true" @endif>
                              {{ $item->id }}
                         </option>
                         @endforeach
                    </select>
     ...
     <div class="row">
          <div class="col-md-6">
               <div class="form-floating mb-3">
                    <input type="text" class="form-control @if($errors->has('volMin')) is-invalid @endif" name="volMin" placeholder="volMin" value="{{old('volMin')}}" />
          ...
          <div class="col-md-6">
               <div class="form-floating mb-3">
                    <input type="number" class="form-control @if($errors->has('pPico')) is-invalid @endif" name="pPico" placeholder="pPico" value="{{old('pPico')}}" />
     ...
     <div class="row">
          <div class="col-md-6">
               <div class="form-floating mb-3">
                    <input type="number" class="form-control @if($errors->has('pMedia')) is-invalid @endif" name="pMedia" placeholder="pMedia" value="{{old('pMedia')}}" />
          ...
          <div class="col-md-6">
               <div class="form-floating mb-3">
                    <input type=text class="form-control @if($errors->has('pPlato')) is-invalid @endif" name="pPlato" placeholder="pPlato" value="{{old('pPlato')}}" />
     ...
     <div class="row">
          <div class="col-md-6">
               <div class="form-floating mb-3">
                    <input type="text" class="form-control @if($errors->has('complacencia')) is-invalid @endif" name="complacencia" placeholder="complacencia" value="{{old('complacencia')}}" />
          ...
          <div class="col-md-6">
               <div class="form-floating mb-3">
                    <input type="text" class="form-control @if($errors->has('resistencia')) is-invalid @endif" name="resistencia" placeholder="resistencia" value="{{old('resistencia')}}" />
     ...
     <div class="row">
          <div class="col">
               <div class="form-floating mb-3">
                    <input type="text" class="form-control @if($errors->has('autoPeep')) is-invalid @endif" name="autoPeep" placeholder="autoPeep" value="{{old('autoPeep')}}" />
